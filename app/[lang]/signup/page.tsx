    ...
    return (
        <LoginBG>
            <div className="w-full max-w-[400px] bg-white rounded-[2.5rem] shadow-2xl border-b-[6px] border-gray-500 p-8 md:p-10 my-8">
                ...
                <button className="w-full flex items-center justify-center gap-3 py-3.5 px-4 bg-white border border-slate-200 rounded-xl font-semibold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all active:scale-[0.98] shadow-sm">
