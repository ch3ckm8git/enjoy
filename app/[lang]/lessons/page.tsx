...
import { CourseSection } from '@/components/ui/lesson_ui/course-section';
import { Menu, GraduationCap, Play } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4 content-evenly">
              ...
              <StatCard
                ...
                value={`${Object.values(userStats.earnedCertificates || {}).filter(Boolean).length} ${t.lessons.earned}`}
                icon="verified"
                color="purple"
              />
